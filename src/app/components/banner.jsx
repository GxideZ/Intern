      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center relative z-10">
        { /* Text Section */}
          <div className="order-2 md:order-2 mt-4 md:mt-0 md:pl-8">
            ...
            <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-10 mt-6">
              <Link
                href="https://www.facebook.com/thn.phathr.sukh.kri"
                className="px-6 py-3 w-full md:w-auto border-2 border-blue-400 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-lg transition-all duration-300 transform hover:scale-110 flex items-center justify-center space-x-3"
              >
                <svg
            ...
            />
              ...
              <Link
                ...
                className="px-6 py-3 w-full md:w-auto bg-gray-900 border-2 border-gray-500 hover:bg-gray-900 text-white rounded-lg shadow-lg transition-all duration-300 transform hover:scale-110 flex items-center justify-center space-x-3"
              >
                <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
