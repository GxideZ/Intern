...
const Aboutme = () => {
  ...
  const skills = [
    ...
    },
    {
      ...
      icon: "📜",
      description:
        "สาราถเขียน JavaScript ในเข้าใจหลักการทำงานในการดึง API ได้ระดับพอใช้ได้",
    },
    {
      skill: "Next.js",
      icon: "⚡",
    ...
    },
    {
      ...
      icon: "⚛️",
      description:
        "เข้าใจโครงสร้างและการทำงานของ React ในระดับปานกลาง จะเขียนเหมือน Next.js",
    },
    {
      skill: "PHP",
      icon: "🐘",
      description:
        "เข้าใจการทำงานของ PHP ได้ระดับปานกลาง สามารถใช้ภาษา PHP ในการดึงข้อมูลจาก Database ได้",
    },
    {
      skill: "MySQL",
      icon: "🛢️",
      description:
        "สามารถสร้างฐานข้อมูล และเข้าใจระบบและหลักการทำงานของ SQL ได้ในระดับปานกลาง",
    },
    {
      skill: "Vue.js",
      icon: "🟢",
    ...
    },
    {
      ...
      icon: "🌬️",
      description:
        "เป็น framework ของ CSS สามารถเขียนและเข้าใจโครงสร้างในการเขียนในระดับปานกลาง",
    },
  ];
